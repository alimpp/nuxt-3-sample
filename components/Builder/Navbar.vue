...
<template>
  <div
    ref="navbar"
    class="backdrop-filter backdrop-blur-md top-0 z-30 w-full flex-none transition-colors duration-300 lg:z-40 border-b border-gray-900/10 dark:border-gray-50/[0.2] bg-white/[0.5] dark:bg-slate-900/[0.5]"
  >
    ...
    <div class="max-w-8xl w-full mx-auto">
      <div class="py-3 lg:px-8 mx-4 lg:mx-0">
        <div class="relative flex items-center">
          ...
          <div
            v-if="$slots['drawer']"
            class="lg:hidden flex items-center self-center justify-center ltr:mr-2 rtl:ml-2"
          >
            <button
      ...
      <Teleport to="#app-after">
        ...
        <Transition name="slide-fade-from-up" mode="out-in">
          <div
            ...
            class="fixed lg:hidden bg-gray-100 dark:bg-slate-800 pt-12 top-0 ltr:left-0 rtl:right-0 w-screen h-screen z-20 flex flex-col"
          >
